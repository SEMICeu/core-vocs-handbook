...
outlined for *Use Case* xref:use-cases.adoc#sec:uc11[*UC1.1*]: "Create a New XSD Schema," showing how to design and create an XSD schema that integrates terms from the

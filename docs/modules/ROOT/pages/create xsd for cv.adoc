...
When a Core Vocabulary, such as CBV, has defined an associated XSD schema, it is essential to import it into your schema using the XML Schema import Element statement. This way, the schema reuses all the complex types, elements, and definitions from the Core Vocabulary. +
...
== Shape XML Document Structure with Patterns

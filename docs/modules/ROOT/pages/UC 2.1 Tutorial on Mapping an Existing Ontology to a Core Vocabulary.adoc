= UC 2.1 tutorial on Mapping an existing Ontology to a Core Vocabulary
...
By following the link:https://semiceu.github.io/core-vocs-handbook/public-review/how-to-map-existing-data-models.html#sec:map-an-existing-ontology:~:text=their%20interoperability%20needs.-,Map%20an%20existing%20Ontology,-This%20section%20provides[map an existing ontology]  **methodology**,
...
== Phase1: Staging (Defining the Requirements)
...
== Phase 6 Application: Operationalise the Mapping

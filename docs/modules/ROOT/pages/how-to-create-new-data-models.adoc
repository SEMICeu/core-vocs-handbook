...
In the Venetian Blind pattern, there is one primary global element, and all other elements are nested inside it. This approach is ideal when a central entity, such as [.custom-highlight]#LegalEntity#, serves as the entry point, as seen in CBV. This pattern fits well with API design, where you typically request information about a central concept (such as [.custom-highlight]#LegalEntity#), and the response includes nested elements, including [.custom-highlight]#LegalName# and [.custom-highlight]#RegisteredAddress#, which are all organised under the main entity. +
Here’s an example, where [.custom-highlight]#LegalEntity# serves as the main entry point:
...
* It uses [.custom-highlight]#LegalEntityType#, which contains various properties such as [.custom-highlight]#LegalName# and [.custom-highlight]#RegisteredAddress#.
...
A [.custom-highlight]#LegalEntity# might contain multiple child elements, such as [.custom-highlight]#LegalName# modelled as a simple string, [.custom-highlight]#RegisteredAddress# (also a complex type), and other related elements. Here's how [.custom-highlight]#LegalEntityType# is defined:
...
Similar to the [.custom-highlight]#LegalEntityType# complex type, the [.custom-highlight]#BusinessAgentType# defines a concept with multiple properties and relationships. However, for [.custom-highlight]#BusinessAgentType#, we define it as a complex type that contains hierarchical relationships, such as [.custom-highlight]#HeadOf# and [.custom-highlight]#MemberOf#.

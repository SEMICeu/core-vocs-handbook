...
The business case translates into the following *use case specification*, which is instantiated from the link:./introduction.adoc#sec:uc11[general UC1.1 description] in the previous section:
...
This section provides detailed instructions for addressing use case link:./introduction.adoc#sec:uc11[UC1.1]. To create a new XSD schema, the following main steps need to be carried out:
...
This section provides guidelines for addressing use case xref:indroduction.adoc#sec:uc12[UC1.2]. 

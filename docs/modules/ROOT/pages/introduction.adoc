...
For first-time readers of this Handbook, we recommend starting with the remainder of this section, where https://github.com/SEMICeu/core-vocs-handbook/blob/develop/docs/modules/ROOT/pages/introduction.adoc#core-vocabularies-handbook[interoperability] is introduced, the role of https://github.com/SEMICeu/core-vocs-handbook/blob/develop/docs/modules/ROOT/pages/semic-core-vocabularies.adoc[Core Vocabularies] is explained, and the important https://github.com/SEMICeu/core-vocs-handbook/blob/develop/docs/modules/ROOT/pages/use-cases.adoc#use-cases[use cases] are summarised.
...
This handbook is intended for two main audiences: 1) administrative professionals, including policy officers and possibly also legal experts, and 2) technical experts and IT professionals.  +
...
* Ensure compliance with the https://semiceu.github.io/style-guide/1.0.0/index.html[SEMIC Style Guide] rules & principles [sem-sg].
...
The European Union has formulated Acts, regulations, and frameworks that intend to foster achieving that, including the https://digital-strategy.ec.europa.eu/en/policies/data-act[Data Act] [data-act], https://digital-strategy.ec.europa.eu/en/policies/data-governance-act[Data Governance Act] [dga], the https://ec.europa.eu/isa2/sites/default/files/eif_brochure_final.pdf[European Interoperability Framework (EIF)] [eif], and the https://interoperable-europe.ec.europa.eu/interoperable-europe/interoperable-europe-act[Interoperable Europe Act] [iea24], which underscore the importance of harmonised data practices across member states. These Acts and frameworks emphasise that true interoperability goes far beyond just connecting systems at a technical level.
...
. *Legal Requirements* – EU regulations and policy frameworks such as_ the Data Act, Data Governance Act_, and the _Interoperable Europe Act_ for structured and secure data exchange. Compliance ensures smoother interactions with public authorities.
...
Interoperability thus consists of a semantic component as well, which "refers to the meaning of data elements and the relationship between them" and "*includes developing vocabularies and schemata to describe data exchanges*" [eif4scc]. According to the https://eur-lex.europa.eu/resource.html?uri=cellar:2c2f2554-0faf-11e7-8a35-01aa75ed71a1.0017.02/DOC_3&format=PDF[EIF, section 3.5] [eif2], *semantic interoperability* "ensures that the precise format and meaning of exchanged data and information is preserved and understood throughout exchanges between parties, in other words ‘what is sent is what is understood’." One recommended way to achieve semantic interoperability between public administrations is to use semantic assets, such as semantic data models, information models, ontologies, and vocabularies. SEMIC uses models called https://semiceu.github.io/style-guide/1.0.0/terminological-clarifications.html#sec:what-is-a-cv-specification:~:text=types%20of%20assets.-,What%20is%20a%20Core%20Vocabulary%20(CV)%20specification%3F,-Definition%0AA%20Core[*Core Vocabularies]*.

[[sec:What_is_a_Core_Vocabulary]]

==== What is a Core Vocabulary?


A *_Core Vocabulary (CV)_* is a basic, reusable, and extensible specification that captures the relevant characteristics of entities, which can be used to add semantics to data and information  in a context-neutral manner [cv-hb]. Its primary purpose is to provide standardised terms that can be reused across various application domains, typically realised as a https://semiceu.github.io/style-guide/1.0.0/gc-semantic-conventions.html#sec:sc-r2[lightweight ontology] (optionally accompanied by a permissive data shape) and documented in a concise specification. Core Vocabularies for SEMIC [sem-sg-cvs] are maintained by the https://interoperable-europe.ec.europa.eu/collection/semic-support-centre[SEMIC action] under the https://interoperable-europe.ec.europa.eu/interoperable-europe[Interoperable Europe] umbrella of DG DIGIT and are described in the https://github.com/SEMICeu/core-vocs-handbook/blob/develop/docs/modules/ROOT/pages/semic-core-vocabularies.adoc#corevocabs[SEMIC Core Vocabularies] section below.

===== SEMIC Core Vocabularies


Since 2011, the European Commission has facilitated international working groups to forge consensus and maintain the SEMIC Core Vocabularies. A short description of these vocabularies is included in the Table below. The latest release of the SEMIC Core Vocabularies can be retrieved via the SEMIC Support Center [https://semiceu.github.io/core-vocs-handbook/public-review/references.html#ref:9[semic]] or directly from the GitHub repository [https://semiceu.github.io/core-vocs-handbook/public-review/references.html#ref:10[semic-gh]] in both human- and machine-readable formats. They are published under the CC-BY 4.0 licence [https://semiceu.github.io/core-vocs-handbook/public-review/references.html#ref:21[cc-by]]. Henceforth, when we use the term Core Vocabularies, we refer to the SEMIC Core Vocabularies specifically.
...
a| image::images/CPV.png[alt="Core Person Vocabulary", width=130]
a|
The **Core Person Vocabulary (CPV)** [cpv] is a simplified, reusable and extensible vocabulary that captures the fundamental characteristics of a person; e.g., the name, gender, date of birth, and location.
...
a| image::images/CBV.png[alt="Core Business Vocabulary", width=130]
a|
The **Core Business Vocabulary (CBV)** [cbv] is a simplified, reusable and extensible vocabulary that captures the fundamental characteristics of a legal entity; e.g., the legal name, activity, and address.
...
a| image::images/CLV.png[alt="Core Location Vocabulary", width=130]
a|
The **Core Location Vocabulary (CLV)** [clv] is a simplified, reusable and extensible vocabulary that captures the fundamental characteristics of a location, represented as an address, a geographic name, or a geometry.
...
a| image::images/CCCEV.png[alt="Core Criterion and Evidence Vocabulary", width=130]
a|
The **Core Criterion and Core Evidence Vocabulary (CCCEV)** [cccev] supports the exchange of information between organisations that define criteria and organisations that respond to these criteria by means of evidence.

It addresses specific needs across the EU, including the following use cases:

* *Facilitate development of interoperable information systems*: common vocabularies improve system interoperability.
* *Create a repository of reusable criteria*: promotes the creation of machine-readable, reusable information.
* *Automate the assessment of criteria*: allows easy comparison and automated evaluation of responses.
* *Automate scoring of responses*: enables weighted scoring across multiple criteria.
* *Promote cross-border participation*: removes language barriers and enhances interoperability in procurement.
* *Calculate statistics*: standardised data allows insights on criteria and evidence.
* *Create a registry of mappings*: supports cross-checking of national criteria and evidence registers.


a| image::images/CPOV.png[alt="Core Public Organisation Vocabulary", width=130]
a|
The **Core Public Organisation Vocabulary (CPOV)** [cpov] provides a vocabulary for describing public organisations in the European Union.

It addresses specific needs of businesses, public administrations and citizens, including the following:

* *Facilitate information sharing*: supports G2G, G2B and G2C information exchange.
* *Facilitate the development of common information systems*: improves interoperability of government systems.
* *Linked Open Organograms*: links organisational data and open datasets.
* *Cross-border information exchange*: enables management of cross-border public service repositories.
* *Find public organisations by function*: improves discovery of authorities responsible for certain policy areas.
* *Increase efficiency*: identifies overlaps or duplication of responsibilities.


a| image::images/CPEV.png[alt="Core Public Event Vocabulary", width=130]
a|
The **Core Public Event Vocabulary (CPEV)** is a simplified, reusable and extensible vocabulary that captures the fundamental characteristics of a public event, e.g. title, date, location, and organiser.

It aims to become a common model for describing public events (e.g., conferences, summits) in the EU, enabling interoperability among registers and ICT-based solutions exchanging and processing event-related information.


a| image::images/CPSV-AP.png[alt="Core Public Service Vocabulary Application Profile", width=200]
a|
The **Core Public Service Vocabulary Application Profile (CPSV-AP)** is a vocabulary for describing public services and the associated life and business events.

With the CPSV-AP it is possible to:

* Provide information on public services in a *user-centric* way, grouped logically around business or life*

|===

The Core Vocabularies are semantic data specifications [sem-sg-wsds] that are disseminated as the following artefacts:

* lightweight ontology [https://semiceu.github.io/core-vocs-handbook/public-review/references.html#ref:11[sem-sg-wio]] for vocabulary definition expressed in OWL [https://semiceu.github.io/core-vocs-handbook/public-review/references.html#ref:12[owl2]];
* loose data shape specification [https://semiceu.github.io/core-vocs-handbook/public-review/references.html#ref:13[sem-sg-wds]] expressed in SHACL [https://semiceu.github.io/core-vocs-handbook/public-review/references.html#ref:14[shacl]];
* human-readable reference documentation [https://semiceu.github.io/core-vocs-handbook/public-review/references.html#ref:15[sem-sg-wdsd]] in HTML (based on ReSpec [https://semiceu.github.io/core-vocs-handbook/public-review/references.html#ref:16[respec]]);
* JSON-LD [https://semiceu.github.io/core-vocs-handbook/public-review/references.html#ref:17[json-ld]] context definitions [https://semiceu.github.io/core-vocs-handbook/public-review/references.html#ref:18[sem-sg-ta]];
* conceptual model specification [https://semiceu.github.io/core-vocs-handbook/public-review/references.html#ref:19[sem-sg-wcm]] expressed in UML Class Diagram notation [https://semiceu.github.io/core-vocs-handbook/public-review/references.html#ref:20[uml]].
...
The SEMIC Core Vocabularies have been developed following the ‘Process and methodology for developing Core Vocabularies’ [https://meaningfy-ws.github.io/semic-docs-staging/core-vocs-handbook/develop/references.html#ref:23[cv-] https://meaningfy-ws.github.io/semic-docs-staging/core-vocs-handbook/develop/references.html#ref:23[met]] of which the most relevant section is depicted in the figure below. Assuming stakeholders and Working Group members with relevant roles are in place, requirements are defined, which are thoroughly assessed on existing standardisation efforts, evidence, and other data models. When a change is deemed necessary, it enters a drafting phase that focuses on the technical details whilst adhering to the SEMIC Style Guide, followed by public consultations. Thereafter, if deemed necessary based on the feedback, it will undergo another modelling iteration, else the changes are refined and the model finalised. The final model is formally approved, implemented, and documented, ensuring they are well-understood and agreed upon by all relevant parties.+

image::images/Semic_process.png[]
...
image::images/primary_Use_Case.png[]
...
|*Note:* A detailed methodology to be applied for use cases will be provided in the xref:UC1.2-description.adoc#sec:create-a-new-json-ld-context-definition[Create a new JSON-LD context definition] section.
...
|*Note:* Since this is a more generic use case it will be broken down into concrete use cases that focus on specific data models and/or data formats. Some of those use cases will be described in detail below, while others will be included in the xref:additional-use-cases.adoc[Appendix], which is dedicated to the additional use cases.
|===
...
|*Note:* A detailed methodology to be applied for this use case will be provided in the xref:description-map-model.adoc[Map an existing Model] section.
|===

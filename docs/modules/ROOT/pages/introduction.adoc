...
* Ensure compliance with the https://semiceu.github.io/style-guide/1.0.0/index.html[SEMIC Style Guide] rules & principles [xref:references.adoc#ref-83[sem-sg]].
...
a|
The **Core Public Event Vocabulary (CPEV)** is a simplified, reusable and extensible vocabulary that captures the fundamental characteristics of a public event, e.g., the title, the date, the location, the organiser etc.
...
|*Example:* ISA2core SAWSDL mapping [xref:references.adoc#ref-36[sa2-map]]
...
The additional use cases are described in the [xref:Appendix.adoc[Appendix]].

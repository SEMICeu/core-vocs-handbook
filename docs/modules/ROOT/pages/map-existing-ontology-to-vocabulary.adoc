...
This tutorial demonstrates how to map the link:https://github.com/SEMICeu/Core-Business-Vocabulary[Core Business Vocabulary]  *(CBV)* to link:https://schema.org[Schema.org], addressing *Use Case* xref:use-cases.adoc#sec:uc21[*UC2.1*].

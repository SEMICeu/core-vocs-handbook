...
Try this in JSON-LD Playground link:https://tinyurl.com/3azpbtyj[here]
...
Use the extended properties to describe more aspects of *Service* instances. For link:https://tinyurl.com/jdv5z62t[example]:

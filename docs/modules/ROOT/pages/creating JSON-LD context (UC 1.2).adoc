...
Try this in JSON-LD Playground link:https://tinyurl.com/mrpyse2u[here]
...
[source,json]
 {
  ...
  "dct:title": "Health Insurance Registration",
  "dct:description": "A service for registering for health insurance.",
  "cpsv:hasRequiredEvidence": {
    "@id": "http://example.org/RequiredEvidence/ProofOfAddress",
    "dct:title": "Proof of Address"
  },
  "cpsv:contactPoint": {
    "@type": "cpsv:ContactPoint",
    "http://example.org/vocab/hasTelephone": "+420776723338"
  }
...
image::image-2025-04-22-22-04-11-289.png[]
===== How to fix:

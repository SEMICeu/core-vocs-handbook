...
|*Note:* A detailed methodology to be applied for this use case will be provided in the xref:create-new-XSD.adoc#sec:guideline-create-new-xsd[Create a new XSD schema]
|===

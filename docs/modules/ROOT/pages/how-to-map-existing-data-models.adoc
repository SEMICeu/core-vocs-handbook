...
The business case translates into the following *use case specification*, which is instantiated from the link:./introduction.adoc#sec:uc21[general UC2.1 description]:
...
This section provides general guidelines to address use case link:./introduction.adoc#sec:uc21[UC2.1], mapping an ontology to a Core Vocabulary.
...
image::UC21guidelineOverview.png[]
...
_Procedure for CBV and Schema.org_
...
_Option 2a. Map XSD to a CV’s main format_
...
_Option 2b. Map a XSD to the XSD of a CV_
...
_Phase 3.1 Conceptual Mapping development_
...
_Phase 3.2: Technical Mapping development_
...
_Phase 3.3: Validation of the RDF output_
...
_Understanding the XML schema_
...
_Create the Technical Mapping_

...
This business case translates into the following *use case specification*, which is instantiated from the link:./introduction.adoc#sec:uc22[general UC2.2 description]:
...
This section provides detailed instructions for addressing use case link:./introduction.adoc#sec:uc22[UC2.2].

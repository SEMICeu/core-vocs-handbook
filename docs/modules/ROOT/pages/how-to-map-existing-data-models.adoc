...
*_Phase 4: Execute the Matching_*
...
*_Phase 1: Staging (Defining the Requirements)_*
...
*_Phase 2: Characterisation (Defining Source and Target models)_*
...
*_Phase 3: Reuse of Existing Mappings_*
...
*_Phase 4: Matching (Execute and Filter Matching Candidates)_*
...
*_Phase 6: Application (Operationalise the Mappings)_*
...
*_Phase 1: Understand XSD schema and prepare test data_*
...
_Option 2-i. Map XSD to a CV’s main format_
...
_Option 2-ii. Map a XSD to the XSD of a CV_
...
*_Phase 3: Transform XML into CV elements_*
...
*_Phase 2: Map XSD schema elements to XSD of the CV_*
...
*_Phase 3: Map XML data to the Core Vocabulary_*

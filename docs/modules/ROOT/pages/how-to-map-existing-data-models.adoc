...
Example output of adding an alignment between [.custom-highlight]#https://semiceu.github.io/Core-Business-Vocabulary/releases/2.00/#Legal%20Entity[legal:LegalEntity]# and [.custom-highlight]#https://schema.org/Organization[schema:Organization]#:
...
==== Phase 1: Understand the XSD schema and prepare test data
...
.Overview of the subprocess of transforming XML into CV elements
image::xmlTOcv.png[width=490]
...
==== Phase 2: Map XSD Schema elements to the XSD of the CV
...
.Visualisation of an orchestration of mappings between the XSD schema, its XML file compliant with it, and the CV
